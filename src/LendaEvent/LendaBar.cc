...
void LendaBar::Finalize(){
  ...
  if (NumTops == 1 ){
    ...
    CorrectedSoftTopTOF=Tops[0].GetCorrectedSoftTime() - Tops[0].GetSoftwareReferenceTime();
  } 
  if (NumBottoms == 1 ){
    ...
    CorrectedSoftBottomTOF=Bottoms[0].GetCorrectedSoftTime() - Bottoms[0].GetSoftwareReferenceTime();
  }
